...
public class ClimbSafeFeatureSet3Controller {
     ...
     * @throws InvalidInputException  If constraints are not respected, the method will throw the corresponding InvalidInputException
     */
   ...
   public static void updateGuide(String email, String newPassword, String newName,
	 ...
	 // Makes sure all the constraints are respected. If they are we set the new input as the guide's input
   ...
   public static void emailValid(String email) throws InvalidInputException {
	 ...
	 if (email == null) throw new InvalidInputException("Password cannot be empty");
	...
	for(int i=0 ; i<email.length(); i++) {
		...
		if (email.charAt(i)== ' ') throw new InvalidInputException("Email must not contain any spaces");
			 ...
			 if(email.indexOf("@") != email.lastIndexOf("@")) throw new InvalidInputException("Invalid email");
		}  
	}
	  ...
	  if(email.lastIndexOf(".") >= email.length()-1) throw new InvalidInputException("Invalid email");
	  
	  // Constraint for the .being right after the @ sign
	  if(email.indexOf("@") == email.indexOf(".") - 1 ) throw new InvalidInputException("Invalid email");
	  ...
	  if (ClimbSafeApplication.getClimbSafe().findGuideFromEmail(email) != null) throw new InvalidInputException("Email already linked to a guide account");
      if (ClimbSafeApplication.getClimbSafe().findMemberFromEmail(email) != null) throw new InvalidInputException("Email already linked to a member account");
  }
  ...
  public static void passwordValid(String password) throws InvalidInputException{
	  ...
	  if (password == null) throw new InvalidInputException("Password cannot be empty");
  ...
  public static void nameValid(String name) throws InvalidInputException{
	...
	if (name == null) throw new InvalidInputException("Name cannot be empty");
  ...
  public static void emergencyContactValid(String emergencyContact) throws InvalidInputException{
    ...
    if (emergencyContact == null) throw new InvalidInputException("Emergency contact cannot be empty");
